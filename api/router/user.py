...
from repository.UserCRUD import get_user_by_name, create_user, update_user, delete_user
...
@router.patch("/")
async def update_current_user(user: BaseUser, current_user=Depends(get_current_user)) -> None:
