...
sesip_evaluation_report_1 = open(f"../api/LLM/prompt/SESIP_Evaluation_Report_Level_1.txt", 'r',
                                 encoding='utf-8').read()
sesip_evaluation_report_2 = open(f"../api/LLM/prompt/SESIP_Evaluation_Report_Level_2.txt", 'r',
                                 encoding='utf-8').read()

sesip_report = {1: sesip_evaluation_report_1, 2: sesip_evaluation_report_2}
...
def get_text_content(pdf_path: str, sesip_lv: int) -> dict[str, str]:
    st = pdf_to_text(pdf_path)
    sesip_evaluation_report = sesip_report[sesip_lv]
